...
{
    internal sealed class ContentTypeFileExtensionProvider
    {
        ...
        /// <summary>
        /// Get the file extension by the MIME type
        /// </summary>
        /// <param name="subpath">A file path</param>
        /// <param name="contentType">The resulting MIME type</param>
        /// <returns>True if MIME type could be determined</returns>
        public static bool TryGetFileExtension(string contentType, [MaybeNullWhen(false)] out string extension)
        {
